    ...
    <div style={{ marginBottom: "100px" }}>
      <Container fixed>
        ...
        >
          ...
          purpose – makes you think anyone else could slice it better.
          <br />
          <br />
          ...
          the ground and left to rot on the streets, but the photographs also
          find beauty in the absurd and banal. 88% of the NFT sale proceeds will
          slip directly into the banana stand because there’s always money in it
          which will be controlled by all current and past NFT holders (le
          Directoire).
          <br />
          <br />
